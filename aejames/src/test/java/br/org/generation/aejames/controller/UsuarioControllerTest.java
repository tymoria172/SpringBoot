package br.org.generation.aejames.controller;
...
public class UsuarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate; // metodos de requisição http
	...
	public void start() {
		...
		usuarioAdmin = new Usuario(0l,"Administrador","administrador@email.com","admin123");
